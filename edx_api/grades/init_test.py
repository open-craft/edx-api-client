...
class GradesApiTestCase(TestCase):
    ...
    def test_api_return_value(self, mock_req):
        ...
        assert isinstance(response, grades.CurrentGrades)
    ...
    def test_ironwood_api(self, mock_req):
        ...
        assert isinstance(grades_response, grades.CurrentGrades)
    ...
    def test_paginated_ironwood_api(self, mock_req):
        ...
        self.assertIsInstance(grades_response, grades.CurrentGrades)
